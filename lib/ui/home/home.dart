      ...
      body: Container(
        child: Padding(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Container(
                child: Row(children: [
              Expanded(child: TextButton(child: Text("Get Started"), onPressed: () {}, style: TextButton.styleFrom(padding: EdgeInsets.symmetric(vertical: 200.0), primary: Colors.white, textStyle: TextStyle(color: Colors.white, fontSize: 18), backgroundColor: Color.fromRGBO(239, 68, 68, 1))))
            ]))
          ]),
        ),
      ),
