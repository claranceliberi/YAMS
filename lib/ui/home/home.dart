      ...
      body: Container(
        child: Padding(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Container(child: TextButton(child: Text("Get Started"), onPressed: () {}, style: TextButton.styleFrom(padding: EdgeInsets.symmetric(vertical: 20.0), primary: Colors.white, textStyle: TextStyle(color: Colors.white, fontSize: 18))))
          ]),
        ),
      ),
    );
